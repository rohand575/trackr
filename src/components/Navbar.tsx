...
export const Navbar: React.FC = () => {
  ...
  return (
    ...
    <header className="sticky top-0 z-30 bg-white/95 dark:bg-gray-900/95 backdrop-blur-sm border-b border-gray-100 dark:border-gray-800 shadow-sm pt-safe transition-colors duration-200">
