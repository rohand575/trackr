    ...
    <div className="fixed inset-0 z-40 flex items-start justify-center px-4 py-6 overflow-y-auto">
      ...
      <div className="relative w-full max-w-2xl bg-white rounded-2xl shadow-2xl animate-scale-in mt-4 mb-4">
        <div className="flex items-center justify-between px-6 py-5 border-b border-gray-100">
          <div>
            <h2 className="text-lg font-bold text-gray-900">{editingDocument ? 'Edit Document' : 'Add Document'}</h2>
            <p className="text-sm text-gray-500 mt-0.5">Track important documents and their expiry dates</p>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="px-6 py-5">
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
            <div className="sm:col-span-2">
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Document Name <span className="text-red-500">*</span></label>
            ...
            <div>
              ...
              <p className="mt-1 text-xs text-gray-400">Leave blank if document has no expiry</p>
            </div>

            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1.5">Remind me (days before expiry)</label>
