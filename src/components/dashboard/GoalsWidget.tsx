    ...
    <div className="relative group" title={goal.title}>
      <div className="relative w-14 h-14">
        <svg className="w-14 h-14 -rotate-90" viewBox="0 0 48 48">
          <circle cx="24" cy="24" r="19" fill="none" className="stroke-gray-100 dark:stroke-gray-700" strokeWidth="4.5" />
          <circle
      ...
      <p className="text-[10px] text-gray-500 dark:text-gray-400 text-center mt-1 w-14 truncate">
  ...
  return (
    <div className="bg-white dark:bg-gray-900 rounded-2xl border border-gray-100 dark:border-gray-800 shadow-sm p-5 flex flex-col gap-4">
      <div className="flex items-center justify-between">
        <h2 className="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wide">Goals</h2>
      ...
      {data.activeGoals.length === 0 ? (
        ...
        <>
            ...
            {overflow > 0 && (
              <div className="flex flex-col items-center">
                <div className="w-14 h-14 rounded-full bg-gray-100 dark:bg-gray-800 flex items-center justify-center">
                  <span className="text-xs font-bold text-gray-500 dark:text-gray-400">+{overflow}</span>
                </div>
                <p className="text-[10px] text-gray-400 dark:text-gray-500 mt-1">more</p>
              </div>
            )}
          </div>
          ...
          <div className="flex gap-2 pt-2 border-t border-gray-50 dark:border-gray-800">
            <span className="flex items-center gap-1 text-xs px-2.5 py-1 rounded-full bg-indigo-50 dark:bg-indigo-950/50 text-indigo-700 dark:text-indigo-300 font-medium">
            ...
            {data.goalsOffTrack > 0 && (
              <span className="flex items-center gap-1 text-xs px-2.5 py-1 rounded-full bg-amber-50 dark:bg-amber-950/40 text-amber-700 dark:text-amber-300 font-medium">
                <svg className="w-3 h-3" fill="none" viewBox="0 0 24 24" stroke="currentColor">
