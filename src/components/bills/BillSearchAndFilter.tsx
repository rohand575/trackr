...
export const BillSearchAndFilter: React.FC = () => {
  const { filters, setFilter, resetFilters } = useBillsStore();
    ...
    <div className="flex flex-wrap items-center gap-3">
      ...
      <div className="relative">
        <select
          ...
          onChange={(e) => setFilter('category', e.target.value as BillFilters['category'])}
      ...
      <div className="relative">
        <select
          ...
          onChange={(e) => setFilter('status', e.target.value as BillFilters['status'])}
          className={selectClass}
        >
      ...
      <div className="relative">
        <select
          ...
          onChange={(e) => setFilter('billingCycle', e.target.value as BillFilters['billingCycle'])}
          className={selectClass}
        >
