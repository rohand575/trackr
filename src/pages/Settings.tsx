  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {biometric.isAvailable && (
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-4">
            <div className="px-5 py-3 border-b border-gray-50">
              <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Security</h2>
            </div>
            <div className="flex items-center justify-between px-5 py-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">Biometric Lock</p>
                  <p className="text-xs text-gray-400">Require biometrics on app launch</p>
                </div>
              </div>
              <button
                ...
                className={`relative inline-flex h-6 w-11 items-center rounded-full transition-colors duration-200 focus:outline-none focus-visible:ring-2 focus-visible:ring-indigo-500 focus-visible:ring-offset-2 disabled:opacity-60 ${
                  biometric.isEnabled ? 'bg-indigo-600' : 'bg-gray-200'
                }`}
              >
                <span
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden mb-4">
          <div className="px-5 py-3 border-b border-gray-50">
            <h2 className="text-xs font-semibold text-gray-400 uppercase tracking-wider">Export</h2>
          </div>
          <div className="flex items-center justify-between px-5 py-4">
            <div className="flex items-center gap-3">
              <div className="w-9 h-9 rounded-xl bg-indigo-50 flex items-center justify-center shrink-0">
              ...
              <div>
                <p className="text-sm font-medium text-gray-900">Export to Calendar (.ics)</p>
                <p className="text-xs text-gray-400">Download upcoming payments and document expirations</p>
              </div>
            </div>
            <button
              onClick={handleExportCalendar}
              disabled={isExporting}
              className="shrink-0 flex items-center gap-1.5 px-3 py-2 text-sm font-medium text-indigo-600 bg-indigo-50 hover:bg-indigo-100 rounded-xl transition-colors disabled:opacity-50"
            >
        ...
        <div className="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
          ...
          <button
            ...
            className="w-full flex items-center gap-3 px-5 py-4 text-left text-sm font-medium text-red-600 hover:bg-red-50 transition-colors disabled:opacity-50"
          >
